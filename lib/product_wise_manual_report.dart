...
void removeProductRow(int index) {
  ...
  Future<void> submitReport() async {
    try {
      ...
      List<Map<String, dynamic>> products = productRows
...
Widget build(BuildContext context) {
  ...
  List<Map<String, dynamic>> filteredCustomers = customer
      .where((c) =>
  ...
  return Scaffold(
    ...
    appBar: AppBar(
      title: const Text("Product Manual Report", style: TextStyle(fontSize: 16)),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.search, color: Colors.teal, size: 18),
                filled: true,
  ...
  child: DropdownButton<int>(
    ...
    onChanged: (value) {
      setState(() {
        productRows[index]["category"] = value;   // store ID
      });
    },
  ),
),
                      ...
                      Text("Qty", style: TextStyle(color: green, fontSize: 13)),
                      const SizedBox(height: 4),
